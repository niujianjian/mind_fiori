		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "ZOPP_GET_LISTSet (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'ZOPP_GET_LISTSet (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function() {
					return this.theListShouldBeSortedAscendingOnField("NetValueMan");
				},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all ZOPP_GET_LISTSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "ZOPP_GET_LISTSet (" + iExpectedLength + ")"
								}),
								success: function() {
