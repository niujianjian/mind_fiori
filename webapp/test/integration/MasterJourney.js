sap.ui.define([
	...
	opaTest("MasterList Filtering on NetValueMan less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("NetValueMan").
	...
	opaTest("MasterList Filtering on NetValueMan more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 Currency").
		and.iPressOKInViewSelectionDialog();
